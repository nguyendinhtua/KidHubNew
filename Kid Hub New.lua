...
local Window = OrionLib:MakeWindow({Name = "TienTiny.Space", HidePremium = false, IntroText = "Kid Library", SaveConfig = true, ConfigFolder = "Kid Hub"})
----------Tab-----------------------
...
elseif World3 then
	tableBoss = {"Kid Gaming Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
